...
var darkBlue = '#08415C'; // Blue
var lightBlue = '#F6AF65';
var barBlue = '#3993DD';
var darkOrange = '#ab386f'; // Orange
var lightOrange = '#F6AF65';
var barOrg = '#F6AF65';
function interpolateColor(value) {
  var isCold = value < 65;
  var startHex = isCold ? darkBlue : darkOrange;
  var endHex = isCold ? lightBlue : lightOrange;
  var barColor = isCold ? barBlue : barOrg;
  var textColor = isCold ? darkBlue : darkOrange;
...
function updateGradient(value) {
  ...
  var bars = document.querySelectorAll('.temp-bar');
...
/* harmony import */ var _backgradienter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./backgradienter */ "./src/backgradienter.js");
        ...
        case 6:
          ...
          for (i = 0; i < days.length; i += 1) {
            ...
            for (j = 0; j < dayData.hour.length; j += 1) {
              ...
              parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.parseISO)(hourDate);
              ogHourIconLink = dayData.hour[j].condition.icon;
              iconHourLink = ogHourIconLink.replace('//cdn.weatherapi.com', '.');
              hourData = {
                time: (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(parsedDate, 'h:mm a'),
...
function loadDayData(dayInd) {
  ...
  rainChancerElement.style.background = "radial-gradient(closest-side, #2b303aff 85%, transparent 80% 100%), conic-gradient(rgb(96, 192, 214) ".concat(currDay.rainChance, "%, rgba(171, 172, 171, 0.33) 0)");
  ...
  snowChancerElement.style.background = "radial-gradient(closest-side, #2b303aff 85%, transparent 80% 100%), conic-gradient(rgb(251, 159, 215) ".concat(currDay.snowChance, "%, rgba(171, 172, 171, 0.33) 0)");
  displayHourlyData(dayInd);
  _backgradienter__WEBPACK_IMPORTED_MODULE_3__["default"].updateGradient(currDay.avgTempF);
}
var currDaySlide = 0;
