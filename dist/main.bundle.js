...
/* Actual custom styling things below */ `, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,oBAAoB;IACpB,4BAA4B;IAC5B,sBAAsB;;IAEtB,yBAAyB;IACzB,0BAA0B;;IAE1B,yBAAyB;IACzB,0BAA0B;AAC9B;;AAEA;IACI,kCAAkC;IAClC,eAAe;AACnB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,UAAU;IACV,SAAS;AACb;;AAEA;IACI,sBAAsB;IACtB,YAAY;IACZ,yBAAyB;IACzB,oBAAoB;IACpB,kBAAkB;IAClB,cAAc;;IAEd,eAAe;IACf,cAAc;AAClB;;AAEA;IACI,eAAe;AACnB;;AAEA;;EAEE,gBAAgB;EAChB,mBAAmB;EACnB,aAAa;AACf;;AAEA;;;GAGG;;AAEH;IACI,gBAAgB;AACpB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,qBAAqB;IACrB,cAAc;AAClB;;AAEA;IACI,aAAa;AACjB;;AAEA,uCAAuC","sourcesContent":[":root {\n    --primary: #519872ff;\n    --primary-lighter: #09bc8aff;\n    --secondary: #118ab2ff;\n\n    --neutral-dark: #2b303aff;\n    --neutral-light: #ebebebff;\n\n    --semantic-bad: #a64253ff;\n    --semantic-good: #37FF8Bff;   \n}\n\nhtml { \n    font-family: Helvetica, sans-serif;\n    font-size: 18px;\n}\n\nbody { \n    height: 100%;\n}\n\n* {\n    padding: 0;\n    margin: 0;\n}\n\nbutton, input, label {\n    box-sizing:content-box;\n    border: none;\n    background-color: inherit;\n    font-family: inherit; \n    font-size: inherit;\n    color: inherit;\n\n    cursor: pointer;\n    display: block;\n}\n\nbutton:active, input:active, label:active{\n    cursor: default;\n}\n\n:where(textarea),\n:where(input[type=\"text\"], input[type=\"search\"], input[type=\"password\"], input[type=\"url\"]){\n  appearance: none;\n  border-style: solid;\n  outline: none;\n} \n\n/* input::placeholder {\n    color: var(--primary-fade);\n    color-scheme: var(--primary-fade);\n} */\n\nul {\n    list-style: none;\n}\n\nsvg {\n    width: 30px;\n}\n\na {\n    text-decoration: none;\n    color: inherit;\n}\n\n.hidden {\n    display: none;\n}\n\n/* Actual custom styling things below */ "],"sourceRoot":""}]);
// Exports
        ...
        case 6:
          ...
          for (i = 0; i < days.length; i += 1) {
            ...
            for (j = 0; j < dayData.hour.length; j += 1) {
              ...
              parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parseISO)(hourDate);
              hourData = {
                time: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(parsedDate, 'h:mm a'),
